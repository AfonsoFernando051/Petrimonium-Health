        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: HealthColors.textMuted, letterSpacing: .6),
            ),
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(u.description, style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w700, color: HealthColors.textPrimary)),
